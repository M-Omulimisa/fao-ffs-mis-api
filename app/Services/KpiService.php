...
class KpiService
{
    ...
    public static function facilitatorScorecard(int $facilitatorId, ?Carbon $weekStart = null): array
    {
        ...
        if ($facilitator && $facilitator->facilitator_start_date) {
            $facilitatorStartDate = $facilitator->facilitator_start_date;
        ...
        $aesaThisWeek = DB::table('aesa_sessions')
            ...
            ->whereBetween('observation_date', [$weekStart, $weekEnd])
            ->count();
        ...
        $scores = [
            ...
            'trainings'  => self::pctScore($trainingsThisWeek, $bench->min_trainings_per_week),
            'meetings'   => self::pctScore($meetingsPerGroup, $bench->min_meetings_per_group_per_week),
            'members'    => self::pctScore($avgMembersPerGroup, $bench->min_members_per_group),
            'aesa'       => self::pctScore($aesaThisWeek, $bench->min_aesa_sessions_per_week),
        ...
        return [
            ...
            'benchmarks' => [
                ...
                'min_aesa_per_week'       => $bench->min_aesa_sessions_per_week,
