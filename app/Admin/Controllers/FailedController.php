...
class FailedController extends AdminController
{
    /**
     ...
     * @var string
     */
    protected $title = 'Failed candidates';
    ...
    protected function grid()
    {
        ...
        $grid->column('stage', __('Stage'))->hide();
        ...
        $grid->column('depature_date', __('Depature date'))->sortable();
